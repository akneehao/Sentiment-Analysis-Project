...
This project focuses on sentiment analysis of over 30,000 reviews from the Klik Indomaret app. It involves end-to-end processing, from data collection to machine learning model development.
...
This project provides valuable insights into user sentiment while showcasing proficiency in data scraping, natural language processing, and machine learning.
